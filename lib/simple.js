...
SimpleDynamoDB.prototype.batchGetItem = function batchGetItem() {
  ...
  for (var key in parsed.requestItems) {
    if (parsed.requestItems.hasOwnProperty(key)) {
      requestItems[key] = formatRequestItems(parsed.requestItems[key], parsed.attributesToGet[key], parsed.consistentRead[key]);
    }
  }
